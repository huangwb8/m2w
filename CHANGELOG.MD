...
### Changed（变更）
- 文档结构优化：删除 README 中的版本对比章节和 TO-DO 章节，统一在 CHANGELOG.MD 中维护版本历史
- 删除未发布版本的表述（v2.8.0 相关功能已移除）
- Maintainers 章节更新：添加贡献者[@Mareep-YANG](https://github.com/Mareep-YANG) 和 [@Shulelk](https://github.com/Shulelk) 及其贡献说明
